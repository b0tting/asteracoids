...
class Asteroid(Mobile):
    def __init__(self, asteroids, gameconfig, start_pos, asteroid_depth, speed=None, scale=None, evade_start_pos=True):
    ...
    def handle_hit(self):
        ...
        if self.asteroid_depth > 0:
            num_pieces = random.randint(self.gameconfig.asteroid_min_pieces,
                                        self.gameconfig.asteroid_max_pieces)
